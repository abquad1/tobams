...
function LMS() {
  return (
    <section className="relative w-full md:py-10">
        <div className="w-full flex flex-col md:flex-row items-center gap-14 bg-primary/10 py-12 px-4 md:px-16">
            {/* left side */}
            <div className="h-120 w-full md:w-2/5 relative">
                    <Image
            ...
            <div className="flex flex-col w-full md:w-3/5 gap-3">
                    ...
                    <div className="flex flex-col rounded-sm text-lg text-foreground bg-primary/10 p-6 gap-5">
