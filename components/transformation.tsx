...
function Transformation() {
  return (
    <section className="relative w-full py-6 md:py-10 px-6 md:px-16">
        <div className="w-full flex flex-col rounded-2xl gap-6 bg-secondary/20 text-primary py-6 px-4 md:py-10 md:px-10">
            
        <div className="flex flex-col gap-2">
            <p className="italic text-sm md:text-xl font-semibold leading-[130%] text-septenary">
            Learning With Our CEO:
            </p>   
            <h3 className="text-primary text-xl md:text-[32px] italic leading-[150%] font-semibold">
            Transformation Hub With Jite Newton
            </h3>
        </div>
        <p className="text-sm md:text-lg text-forground leading-[150%]">
        ...
        <div className="w-full flex flex-col md:flex-row gap-8 rounded-2xl text-primary">
            ...
            {/* right side */}
            <div className="flex flex-col w-full md:w-3/5 gap-8 rounded-xl bg-background/30 py-4 md:py-8 px-4 md:px-5">
                <ul className="flex flex-col md:grid grid-cols-2 gap-6 ">
                    {programs.map((program) => (
                            <li
                            key={program}
                            className="flex items-center gap-2.25 p-4 bg-background text-sm md:text-lg rounded-xl text-primary leading-[150%]"
                            >
